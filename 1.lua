...
local StartRemote = ReplicatedStorage:WaitForChild("StartFishing")
local ReelRemote = ReplicatedStorage:WaitForChild("ReelFish")
local NotifyRemote = ReplicatedStorage:WaitForChild("NotificationFishing")
